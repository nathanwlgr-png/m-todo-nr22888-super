...
import NR22DailyMotivation from '@/components/NR22DailyMotivation';
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* ── TAB SCORE IA ── */}
          <TabsContent value="score" className="overflow-y-auto p-3">
            <NR22ScorePreditivo
              client={client}
              scoreData={scoreData}
              loadingScore={loadingScore}
              onRefresh={() => loadClientScore(client)}
            />
          </TabsContent>

          {/* ── TAB COACHING IA ── */}
          <TabsContent value="coaching" className="overflow-y-auto p-3">
            <NR22CoachingIA
              client={client}
              coachingData={coachingData}
              loadingCoaching={loadingCoaching}
              onGenerate={loadCoaching}
            />
          </TabsContent>
