...
import { 
        ...
        ChevronRight, Bell, MessageSquare, TrendingUp, Award, Target, Sparkles, Package, FileText, Database, Brain, MapPin, Upload
      } from 'lucide-react';
...
export default function Layout({ children, currentPageName }) {
  ...
  const menuItems = [
    ...
    { icon: Brain, label: '🧠 Sentimento IA', page: 'SentimentHub' },
    { icon: BarChart3, label: '📊 Dashboard Intel.', page: 'IntelligenceDashboard' },
    { icon: Crown, label: '👑 Busca Elite Vet', page: 'EliteVetSearch' },
