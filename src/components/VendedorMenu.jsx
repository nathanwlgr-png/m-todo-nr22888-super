...
const ADMIN_CATEGORIES = [
  {
    ...
    pages: [
      ...
      { page: 'ProposalGenerator', label: '📄 Propostas' },
      { page: 'EquipmentCatalog', label: '🔬 Catálogo' },
      { page: 'ScheduledAgenda', label: '📅 Agenda' },
    ],
  },
  {
    label: '🧠 IA & Investigação',
    pages: [
      { page: 'ModoInvestigacaoSuprema', label: '🕵️ Investigação Suprema' },
      ...
      { page: 'GenerateWhatsAppIntegrated', label: '⚡ SPIN Selling' },
    ],
  },
  {
    label: '🗺️ Campo & Rotas',
  ...
  },
  {
    ...
    pages: [
      ...
      { page: 'WhatsAppMasterAssistantLapidado', label: '🤖 Assistente Master' },
  ...
  },
  {
    ...
    pages: [
      ...
      { page: 'AutomationSettings', label: '⚙️ Automações' },
      { page: 'ContactSettings', label: '🛠️ Configurações' },
